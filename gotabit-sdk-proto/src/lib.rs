...
pub mod cosmos {
    pub mod app {
        pub mod v1alpha1 {
            include!("prost/cosmos-sdk/cosmos.app.v1alpha1.rs");
        }

        pub mod module {
            pub mod v1alpha1 {
                include!("prost/cosmos-sdk/cosmos.app.module.v1alpha1.rs");
            }
        }
    }
    ...
    pub mod base {
        ...
        pub mod capability {
            pub mod v1beta1 {
                include!("prost/cosmos-sdk/cosmos.capability.v1beta1.rs");
            }
        }
    }
    ...
    pub mod crypto {
        ...
        pub mod hd {
            pub mod v1 {
                include!("prost/cosmos-sdk/cosmos.crypto.hd.v1.rs");
            }
        }
        // keyring support
        pub mod keyring {
            pub mod v1 {
                include!("prost/cosmos-sdk/cosmos.crypto.keyring.v1.rs");
            }
        }
    }
    ...
    /// Message and services handling nft
    pub mod nft {
        pub mod v1beta1 {
            include!("prost/cosmos-sdk/cosmos.nft.v1beta1.rs");
        }
    }
    ...
    /// Messages and services handling orm module
    pub mod orm {
        pub mod v1 {
            include!("prost/cosmos-sdk/cosmos.orm.v1.rs");
        }

        pub mod v1alpha1 {
            include!("prost/cosmos-sdk/cosmos.orm.v1alpha1.rs");
        }

        pub mod module {
            pub mod v1alpha1 {
                include!("prost/cosmos-sdk/cosmos.orm.module.v1alpha1.rs");
            }
        }
    }
